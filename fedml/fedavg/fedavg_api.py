...
class FedAvgAPI(object):
    ...
    def _instanciate_opt(self):
        if self.args.server_optimizer == 'Adam':
            self.opt = torch.optim.Adam(self.model_trainer.model.parameters(), lr=0.001)
    ...
    def train(self):
        ...
        for round_idx in range(self.args.comm_round):
            ...
            if self.args.server_optim and self.args.server_optimizer == 'DFW':
                ...
                # Ensure avg_loss is a tensor and perform backward
                avg_loss_tensor = torch.tensor(avg_loss, requires_grad=True)
